...
- `script.js`: This file contains JavaScript for dynamic and interactive features, such as fetching data and populating the catalog page. To maintain simplicity for beginners, its code should remain relatively straightforward and focused.
